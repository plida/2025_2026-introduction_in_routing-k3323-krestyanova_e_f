/ip address
add address=172.16.192.1/30 interface=ether2
add address=172.16.128.2/30 interface=ether3
...
/ip route
add distance=1 dst-address=10.1.0.0/16 gateway=172.16.192.2
add distance=1 dst-address=10.2.0.0/16 gateway=172.16.128.1
/user
